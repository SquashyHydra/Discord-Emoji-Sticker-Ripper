...
#define AppName "Discord Ripper PRO GUI"
#define DirName "Discord Ripper PRO GUI"
#define OutputFolder "output"

#define InputFolder "output\gui.dist"
#define LaunchExe "Discord Ripper PRO.exe"
...
Name: "{userdesktop}\{#AppName}"; Filename: "{app}\{#LaunchExe}"; WorkingDir: "{app}"; Tasks: "desktopicons";

[Tasks]
Name: "desktopicon"; Description: "Create a &desktop icon"; GroupDescription: "Additional icons:"; Flags: unchecked

[Run]
Filename: "{app}\{#LaunchExe}"; Description: "Launch Discord Ripper PRO"; Flags: nowait postinstall skipifsilent
